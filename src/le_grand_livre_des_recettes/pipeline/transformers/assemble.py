...
et l'assemblage complet via des jointures LEFT sur `layer1`[cite: 2]. Une déduplication
finale sur `id` garantit l'unicité des recettes malgré les jointures floues sur `title_norm`[cite: 2].
"""
...
def assemble(spark: SparkSession) -> DataFrame:
    ...
    assemble le tout via des LEFT JOIN sur le DataFrame principal (`layer1`)[cite: 2].
    """
