...
au format Parquet dans le répertoire de staging (format intermédiaire jetable).
Les tables finales persistantes sont écrites en Delta Lake par Spark (phase 2).
